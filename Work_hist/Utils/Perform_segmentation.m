function [IND_Final, idx, ipt, feature1, residual, y_hat, r2adj, IND_Do] = Perform_segmentation(feature1,n_cp,residual)
...
[ipt,residue] = findchangepts(feature1,'Statistic','linear','MaxNumChanges',n_cp);
...
% Set the Final Segment based on R-squared values
if min(r2adj) > 0.98
